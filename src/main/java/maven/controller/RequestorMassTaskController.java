...
public class RequestorMassTaskController {
    ...
    Exception uploadMassTaskDetail(String requestorId, String massTaskDetailVOJson){
        ...
        return requestorMassTaskBL.uploadMassTaskDetail(new UserId(requestorId), new MassTaskDetail(massTaskDetailVO));
    }
